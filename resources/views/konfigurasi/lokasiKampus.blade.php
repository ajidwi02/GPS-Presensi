      ...
      <div class="col-6">
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <form action="/konfigurasi/updatelokasiKampus" method="POST">
              @csrf
              <div class="row">
                <div class="col-12">
                  <div class="input-icon mb-3">
                    ...
                    <input type="text" value="{{ $lokasiKampus->lokasi_kampus }}" id="lokasiKampus" class="form-control" name="lokasiKampus" placeholder="Lokasi Kampus">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="input-icon mb-3">
                    ...
                    <input type="text" value="{{ $lokasiKampus->radius }}" id="radius" class="form-control" name="radius" placeholder="Radius Kampus">
                  </div>
                </div>
              </div>
              <div class="row">
